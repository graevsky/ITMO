const MAX_R = 4;
const scaleFactor = Math.min(canvas.width, canvas.height) / (2 * MAX_R);
...
function drawGraph(rValue) {
    ...
    ctx.fillRect(canvas.width / 2, canvas.height / 2, -rValue/2 * scaleFactor, rValue * scaleFactor);

    ctx.beginPath();
    ctx.moveTo(canvas.width / 2, canvas.height / 2);
    ctx.arc(canvas.width / 2, canvas.height / 2, rValue * scaleFactor, Math.PI, Math.PI * 1.5, false);
    ctx.closePath();
    ctx.fill();

    ctx.beginPath();
    ctx.moveTo(canvas.width / 2, canvas.height / 2);
    ctx.lineTo(canvas.width / 2 + rValue * 0.5 * scaleFactor, canvas.height / 2);
